...
SECRET_KEY = 'django-insecure-y^!4me$g&(062&1166lxboq^62(3fpv+cgqdv9bkqumt!c3xsv'
...
STATIC_URL = 'static/'
import os # Додай цей імпорт десь на самому початку файлу, поруч з from pathlib import Path

# ... (інші налаштування внизу файлу) ...
...
# НАЛАШТУВАННЯ РЕАЛЬНОГО EMAIL (SMTP Google)
